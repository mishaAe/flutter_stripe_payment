...
public final class GoogleApiPayFlowImpl extends PayFlow {
    ...
    private void isReadyToPay(@NonNull Activity activity, boolean isExistingPaymentMethodRequired, @NonNull final Promise promise) {
        ...
        googlePayJsonFactory = new GooglePayJsonFactory(activity);
    ...
    private void startPaymentRequest(@NonNull Activity activity, @NonNull PaymentDataRequest request) {
        ...
        mPaymentsClient = createPaymentsClient(activity);
        PaymentConfiguration.init(activity, getPublishableKey());
        googlePayJsonFactory = new GooglePayJsonFactory(activity);
        String jsonString = googlePayJsonFactory.createPaymentDataRequest(
                new GooglePayJsonFactory.TransactionInfo("USD",
                        ...
                        null,
                        null),
                new GooglePayJsonFactory.BillingAddressParameters(true,
                        GooglePayJsonFactory.BillingAddressParameters.Format.Min,
                        false),
                new GooglePayJsonFactory.ShippingAddressParameters(true, new HashSet<>(Arrays.asList("US", "DE", "RU")), false),
                false,
                new GooglePayJsonFactory.MerchantInfo("Widget Store")
                    ...
                    case Activity.RESULT_OK:
                        ...
                        try {
                            ...
                            paymentMethodCreateParams =
                                    PaymentMethodCreateParams.createFromGooglePay(paymentJson);
                        ...
                        if (paymentMethodCreateParams == null) {
                            ...
                            createPaymentMethod(paymentMethodCreateParams, payPromise);
                        }
                        break;
    ...
    public void createPaymentMethod(final PaymentMethodCreateParams pmcp, final Promise promise) {

        getStripe().createPaymentMethod(pmcp, new ApiResultCallback<PaymentMethod>() {
